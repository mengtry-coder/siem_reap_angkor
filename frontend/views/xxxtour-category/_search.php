    ...
    <div class="col-md-12 search-bd"> 
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-2">
                    <?php
                        $tour_item = ArrayHelper::map(\backend\models\TourItem::find()
                        ->where(['status'=>1, 'company_id' => 1])
                        ->all(), 'id', function($model){return $model->name;});
                    ?>
                     
                    <?=$form->field($model, 'name')->dropDownList($tour_item, ['prompt' => 'Tour Category'])->label(false);?>
                </div>
                <div class="col-md-2">
