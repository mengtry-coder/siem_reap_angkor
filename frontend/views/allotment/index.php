...
if(isset($searchModel->from_date)){
    ...
    $category_id = $searchModel->tour_category_id;


    Yii::$app->session->set('tour_category_id',$category_id);
    ...
    Yii::$app->session->set('tour_category_id',"");
    $hide = 'hidden';
                ...
                <div class="row item-listing">
                    ...
                    <div id="box-vile" class="container-fluid box-shadow" style="position: relative;">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 wrap_des"><br>
                            ...
                            <label for="">Category: <?= TourCategory::find()->where(['id' => $model->tourItem->category_id])->one()->name;?>
