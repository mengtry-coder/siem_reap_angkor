...
<div class="site-index">
    <div class="body-content">
        ...
        <div class="search-form">
            <div class="container">
                <div class="search-fieldx">
                    <?php echo $this->render('../allotment/_search', ['model' => $searchModel]); ?>  
                </div>
            </div>
        </div>
        <!-- End Search Form -->
        <!-- About us -->
        <div class="about-us" style="padding-top: 100px;">
            <div class="container">
                <div class="head-text">
                    <h2>Adventures To Fill Your Spirit</h2>
                    <div style="width: 50px; height: 2px; background-color: #ed008c; margin: 0 auto;"></div>
                </div>
                <div class="the-content about-sumary-home">
                    <p><?= \backend\models\CompanyProfile::find()->where(['id'=>1])->one()->description ;?></p>
                </div>
            </div>
        </div>
        <!-- End About us -->
        <!-- Product Listing -->
        <h2 style="margin-bottom: 0px;"><i style="color: black;">Life Is Either A Daring Adventure</i></h2><br>
        <h3 style="margin: 0px; text-align: center; "><i style="font-size: 30px;">Or Nothing At All</i></h3><br>
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php 
                     ...
                     ?>
                    <div class="col-md-3 col-xs-6" data-aos="zoom-in">
                        <figure class="snip1369 green">
                            ...
                            <a href="<?= Url::toRoute(['allotment/item-detail', 'id' => $value['id']]) ?>"></a>
                        </figure>
                    </div>
                    <?php  
                        }
                ...
                <div class="wrap-tour-package">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            ?>
                            <div class="col-md-6 <?=$pull_right;?>" data-aos="fade-right">
                                <div class="grid">
                                    <div class="grid__item">
                                        <div class="card">
                                            ...
                                            <div class="card__content">
                                                ...
                                                <a href="<?= Url::toRoute(['allotment/index']) ?>"><button class="card__btn">See all <span>&rarr;</span></button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 pull-left" >
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php 
                                            $items = \backend\models\TourItem::find()->where(['category_id'=>$value['id'], 'status'=>1])->limit(4)->all();
       ...
       <!--  <section class="banner-wide teal has-negative-margin">
            ...
            <div class="container">
                ...
                <!-- <div class="contact-form">
                    ...
                    <?php $form = ActiveForm::begin([
                        ...
                        <input type="email" class="form-control" required name="e-mail" placeholder="Your E-mail Adress" />
                        <input type="tel" class="form-control" required name="phone" placeholder="Your Phone Number"/>
                        <textarea name="message" class="form-control" id="" rows="8" placeholder="Your Message" style="height: 80px;"></textarea>
                        <button type = "submit" class="btn-send form-control">Get a Call Back</button>
                    <?php ActiveForm::end(); ?>
                </div> -->
            </div>
        </div>
        <!-- End Map & Contact -->
        <!-- Subscribe Email-->
        <div class="subscribe" style="background-image: url('../web/img/wine.jpg');">
            <div class="overlay-background">
                <div class="container">
                    <div class="wrap-newletters">
                        <div class="tnp tnp-subscribeion subscribe-box">
                        <?php $form = ActiveForm::begin([
                            ...
                            <div class="custom-submit">
                                <div class="tnp-field tnp-field-email">
                                    <input class="tnp-email email" type="email" placeholder="Email" name = "email" required="">
                                </div>
                                <div class="tnp-field tnp-field-button">
                                    <input class="tnp-submit subscribe-button" type="submit"  value="subscribe">
                                </div>
                            </div>
                        <?php ActiveForm::end(); ?> 
                        </div>
...
/*------subscribe Email----------*/
    ...
    .subscribe .overlay-background .wrap-newletters {
        text-align: center;
    }
    .subscribe .overlay-background .wrap-newletters h4 {
        color: #fff;
        font-family: "Frank Ruhl Libre",serif;
        font-size: 26px;
    }
    .subscribe .overlay-background .wrap-newletters p {
        color: #fff;
        font-size: 13px;
    }
    .subscribe .overlay-background .wrap-newletters .subscribe-box {
        text-align: left;
    }
    .tnp-subscribeion {
        font-size: 13px;
    ...
    .subscribe .overlay-background .wrap-newletters .subscribe-box .custom-submit {
        display: inline-flex;
    }
    .tnp-subscribeion div.tnp-field {
        margin-bottom: 10px;
        border: 0;
        padding: 0;
    }
    .subscribe .overlay-background .wrap-newletters .subscribe-box .custom-submit .email {
        width: 378px;
        height: unset;
        padding: 12px;
        font-size: 16px;
    ...
    .subscribe .overlay-background .wrap-newletters .subscribe-box .custom-submit .subscribe-button {
        margin-left: 20px;
        padding: 12px 30px;
        font-size: 16px;
        color: #fff;
