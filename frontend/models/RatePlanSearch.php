...
/**
 * RatePlanSearch represents the model behind the search form of `frontend\models\RatePlan`.
 */
class RatePlanSearch extends RatePlan
{
    ...
    {
        return [
            [['id', 'company_id', 'tour_item_id', 'rate_range_id', 'mark_up_type', 'updated_by', 'status', 'created_by'], 'integer'],
