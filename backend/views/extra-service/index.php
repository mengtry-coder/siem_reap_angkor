...
/* @var $searchModel backend\models\ExtraServiceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Extra Services';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="extra-service-index">
<h5><?= Html::encode($this->title) ?></h5>
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-success" id="modalButton" value="<?= Url::toRoute(['extra-service/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Extra Services'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
        ...
        <div class="table-responsive">
            ...
            'name',
            [
                'attribute' => 'adult_price',
                'format' => 'raw',
                'value' => function ($model) {
                    return "USD ".$model->adult_price;
                },
            ],
            [
...
$this->registerJs('
var controller_id = "extra-service";
