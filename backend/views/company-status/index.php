...
/* @var $searchModel backend\models\CompanyStatusSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Company Statuses';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="company-status-index">
<h5><?= Html::encode($this->title) ?></h5>
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-success" id="modalButton" value="<?= Url::toRoute(['company-status/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Company Statuses'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
...
$this->registerJs('
var controller_id = "company-status";
